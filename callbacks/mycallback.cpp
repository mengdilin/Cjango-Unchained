...
extern "C" http::HttpResponse page_home(http::HttpRequest request) {
  ...
  return http::HttpResponse::render_to_response("callbacks/templates/home.html");
}
...
extern "C" http::HttpResponse page_index(http::HttpRequest request) {
  ...
  auto resp = http::HttpResponse::render_to_response("callbacks/templates/index.html");
  _DEBUG(resp.to_string());
  return resp;
}
